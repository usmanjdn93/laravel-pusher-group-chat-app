            ...
            <div class="panel-collapse" :id="'collapseOne-' + group.id">
                <div class="panel-body chat-panel msg_container_base" id="messages">
                    <span v-for="conversation in conversations">
                        <div v-if="user.id != conversation.user_id" class="row msg_container base_sent">
                            <div class="col-md-10 col-xs-10">
                                <div class="messages msg_sent">
                                    <p>{{conversation.message}}</p>
                                        <time>{{conversation.user.name}} • 
                                            <strong>
                        ...
                        <div v-else class="row msg_container base_receive">
                            <div class="col-md-2 col-xs-2 avatar">
                                <img src="http://www.bitrebels.com/wp-content/uploads/2011/02/Original-Facebook-Geek-Profile-Avatar-7.jpg" class=" img-responsive ">
                            </div>
                            <div class="col-md-10 col-xs-10">
